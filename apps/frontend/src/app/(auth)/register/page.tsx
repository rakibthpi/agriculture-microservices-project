...
export default function RegisterPage() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?q=80&w=1600')",
      }}
    >
      ...
      <Card className="w-full max-w-md relative z-10 border-none shadow-2xl animate-fade-in">
        <CardHeader className="text-center space-y-2 pb-8">
          ...
          <p className="text-gray-500">Join our marketplace to buy fresh from farms.</p>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <Input
                  ...
                  required
                />
                <User className="absolute left-3 top-3.5 h-5 w-5 text-gray-400 group-hover:text-primary-500 transition-colors" />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                />
                <Phone className="absolute left-3 top-3.5 h-5 w-5 text-gray-400 group-hover:text-primary-500 transition-colors" />
              </div>
            </div>
